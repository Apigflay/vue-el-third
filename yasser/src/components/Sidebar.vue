...
<!-- 四个菜单：1.主播时长   2. 主播娃娃   3.主播流水   4. 主播管理  5. 密码修改 -->
            ...
            <el-submenu index="1"> 
                ...
                <span slot="title">主播时长</span>
                </template>
                <el-menu-item-group>
                <router-link to="/hostduration">
                    <el-menu-item index="11">主播时长</el-menu-item>
                </router-link>
                </el-menu-item-group>
            </el-submenu>
            <el-submenu index="2">
                ...
                <span slot="title">主播娃娃</span>
                </template>
                <el-menu-item-group>
                <router-link to="/anchordoll">
                    <el-menu-item index="21">主播娃娃</el-menu-item>
                </router-link>
                </el-menu-item-group>
            </el-submenu>
            <el-submenu index="3">
                ...
                <span slot="title">主播流水</span>
                </template>
                <el-menu-item-group>
                <router-link to="/anchorpipeline">
                    <el-menu-item index="31">主播流水</el-menu-item>
                </router-link>
                </el-menu-item-group>
            </el-submenu>
            <el-submenu index="4">
                ...
                <el-menu-item-group>
                <router-link to="/anchormanagement">
                    <el-menu-item index="41">主播管理</el-menu-item>
                </router-link>
                </el-menu-item-group>
            </el-submenu>
            <el-submenu index="5">
                ...
                <el-menu-item-group>
                <router-link to="/passwordmodification">
                    <el-menu-item index="51">密码修改</el-menu-item>
                </router-link>
                </el-menu-item-group>
            </el-submenu>
